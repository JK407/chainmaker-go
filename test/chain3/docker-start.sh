...
function start_vm_go() {
  container_name=VM-GO-wx-org$1.ci-chain3
  ...
  xsed "s%enable: false%enable: true%g" ./config/node$1/chainmaker.yml
...
start_vm_go 1 "./data/wx-org1.chainmaker.org/go" "./log/node1-dockergo" 32351 22351
start_vm_go 2 "./data/wx-org2.chainmaker.org/go" "./log/node2-dockergo" 32352 22352
start_vm_go 3 "./data/wx-org3.chainmaker.org/go" "./log/node3-dockergo" 32353 22353
start_vm_go 4 "./data/wx-org4.chainmaker.org/go" "./log/node4-dockergo" 32354 22354
sleep 3
docker ps | grep "ci-chain3"